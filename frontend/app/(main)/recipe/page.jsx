                ...
                <div className="mt-6 pt-6 border-t-2 border-stone-200">
                  ...
                  >
                    <div className="grid grid-cols-2 gap-2">
                      <div className="bg-orange-50 p-2 text-center border-2 border-orange-100">
                        <div className="text-lg font-bold text-orange-600">
                          {recipe.nutrition.calories}
                        </div>
                        <div className="text-xs text-stone-500 font-bold uppercase tracking-wide leading-tight">
                          Calories
                        </div>
                      </div>

                      <div className="bg-stone-50 p-2 text-center border-2 border-stone-100">
